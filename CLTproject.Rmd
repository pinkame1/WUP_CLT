...
This graph shows that there is one peal and the mean is 'r mean(my1000$k9)', the sd is 'r sd(my1000$k9)'. 
...
There is only one peak in this graph and the mean is ' mean (my1000$k16) and the sd is 'r sd(my1000$k16).
