...
There is only one peak in this graph just as the other graphs. The mean `r mean(my1000$k16)` and the sd is `rsd(1000$k16)`. 
...
This graph shows that there is a pattern within all these graphs which is one peak. This graph has a mean of `r mean(my1000$k25)`, the sd is `r sd(my1000$k25)`. 